...
$e^{total}_u = e_u^{0}\mid \mid ..\mid \mid  e_u^{(L)}$, $e^{total}_i=e_i^{(0)}\mid \mid ...\mid \mid e_i^{(L)}$,$\mid \mid = concatenation$
...
$Loss  = \sum\limits_{(u,i,j)\in O} -ln \sigma (\hat y_{ui}-\hat y_{uj}) + \lambda \mid \mid \theta \mid \mid^2$
...
MF, NeuMF에 대한 이야기로 시작을 해서, 간단하게 설명하고 넘어가겠다. (자세한 내용은 다음 블로그 링크([MF](https://changhyeonnam.github.io/2021/12/21/Matrix_Factorization.html), [NeuMF](https://changhyeonnam.github.io/2021/12/28/Neural_Collaborative_Filtering.html))를 확인) MF은 user-item의 linearity한 relation만 고려하기 때문에w, ranking loss가 있었다. NeuMF에서는 이것을 고려하여 non-linearity도 고려했다. 두 모델 외에도 LRML이라는 translation-based  CF model도 소개되었다. 이런 딥러닝 모델도 성능이 좋았음에도 불구하고, design of embedding function은 CF signal은 implicitly capture되기 때문에 optimal CF embedding을 구성하기엔 불충분했다.
...
<div class="center">
  <figure>
    <a href="/images/2022/paper/NGCF/lec3.png"><img src="/images/2022/paper/NGCF/lec3.png" width="600"  ></a>
  </figure>
</div>
...
<div class="center">
  <figure>
    <a href="/images/2022/paper/NGCF/lec4.png"><img src="/images/2022/paper/NGCF/lec4.png" width="600"  ></a>
  </figure>
</div>
...
<div class="center">
  <figure>
    <a href="/images/2022/paper/NGCF/lec5.png"><img src="/images/2022/paper/NGCF/lec5.png" width="600"  ></a>
  </figure>
</div>
...
<div class="center">
  <figure>
    <a href="/images/2022/paper/NGCF/lec6.png"><img src="/images/2022/paper/NGCF/lec6.png" width="600"  ></a>
  </figure>
</div>
...
<div class="center">
  <figure>
    <a href="/images/2022/paper/NGCF/lec7.png"><img src="/images/2022/paper/NGCF/lec7.png" width="600"  ></a>
  </figure>
</div>
...
<div class="center">
  <figure>
    <a href="/images/2022/paper/NGCF/lec8.png"><img src="/images/2022/paper/NGCF/lec8.png" width="600"  ></a>
  </figure>
</div>
...
<div class="center">
  <figure>
    <a href="/images/2022/paper/NGCF/lec9.png"><img src="/images/2022/paper/NGCF/lec9.png" width="600"  ></a>
  </figure>
</div>
...
<div class="center">
  <figure>
    <a href="/images/2022/paper/NGCF/lec10.png"><img src="/images/2022/paper/NGCF/lec10.png" width="600"  ></a>
  </figure>
</div> -->
