...
- mode
    ...
    ![Untitled.png](/images/2021/linux/a0.png)
...
![Untitled.png](/images/2021/linux/a1.png)
...
- open file들은 v node 구조체를 갖고있고, vnode는 파일의 타입과 파일에 실행되는 함수들에 대한 포인터를 포함하고 있습니다.
    ...
    ![Untitled.png](/images/2021/linux/b4.png)
...
1. `int dup(int filedes)` : 존재하고 있는 file descriptor 값을 받아 복사하여 새로운 fd를 반환합니다.
    ...
    ![Untitled.png](/images/2021/linux/b5.png)
...
2. `int dup2(int filedes, int filedes2)` : fildes에 해당하는 파일을 filedes2에 해당하는 파일로 저장합니다. 새로운 파일 디스크립터 filedes2를 반환합니다.
    ...
    ![Untitled.png](/images/2021/linux/b6.png)
...
- cmd
    ...
    ![Untitled.png](/images/2021/linux/b7.png)
...
![Untitled.png](/images/2021/linux/b8.png)
