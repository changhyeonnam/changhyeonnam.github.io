...
모든 도로에 적어도 하나 이상의 버스 노선이 지나가는 버스 노선의 최소 개수를 구하는 문제이다. ~~즉, 서로다른 리프노드에 도달하는 경로의 개수를 구해야 한다.~~

![tr0](/images/2021/tree/tr0.png)
...
노드 x와 x의 서브트리가 있을때, 서브트리는 x가 멘토를 갖고있는 지만 관심이 있다. 즉, dp[x][hasMento]를 사용하면 된다. (항상 dp 2차원배열이상으로 늘어나면 헤멘다..)

![tr1.png](/images/2021/tree/tr1.png)
