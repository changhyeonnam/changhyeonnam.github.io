...
- 3가지 연산
    - make(v)  : 개체 v가 속해있는 집합 만들기
      ...
      <div class="center">
        <figure>
          <a href="/images/2021/dsu/dsu10.png"><img src="/images/2021/dsu/dsu10.png" width="300" ></a>
        </figure>
      </div>

      <div class="center">
        <figure>
          <a href="/images/2021/dsu/dsu2.png"><img src="/images/2021/dsu/dsu2.png" width="300" ></a>
        </figure>
      </div>
    ...
    - union(A,  B) : 집합 A와 집합 B 합치기
      ...
      <div class="center">
        <figure>
          <a href="/images/2021/dsu/dsu3.png"><img src="/images/2021/dsu/dsu3.png" width="300" ></a>
        </figure>
      </div>
        ...
        <div class="center">
          <figure>
            <a href="/images/2021/dsu/dsu1.png"><img src="/images/2021/dsu/dsu1.png" width="300" ></a>
          </figure>
        </div>
...
- 구현 : find
  ...
  <div class="center">
    <figure>
      <a href="/images/2021/dsu/dsu5.png"><img src="/images/2021/dsu/dsu5.png" width="300" ></a>
    </figure>
  </div>
...
- 구현 : union
  ...
  <div class="center">
    <figure>
      <a href="/images/2021/dsu/dsu6.png"><img src="/images/2021/dsu/dsu6.png" width="500" ></a>
    </figure>
  </div>
...
<div class="center">
  <figure>
    <a href="/images/2021/dsu/dsu8.png"><img src="/images/2021/dsu/dsu8.png" width="300" ></a>
  </figure>
</div>
...
<div class="center">
  <figure>
    <a href="/images/2021/dsu/dsu9.png"><img src="/images/2021/dsu/dsu9.png" width="400" ></a>
  </figure>
</div>
...
같은 종류의 소 일 경우 같은 집합으로 묶어준다. 인접된 노드의 부모가 다른 경우 H,G가 모두 있는 경우이고, 부모가 같다면 H인지 G인지 확인하면 된다.
