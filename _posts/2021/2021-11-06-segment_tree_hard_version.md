...
<div class="center">
  <figure>
    <a href="/images/2021/segment/a3.png"><img src="/images/2021/segment/a3.png" width="400"></a>
  </figure>
</div>
왼쪽구간의 가장 오른쪽 수(mid-1)를 포함하는 가장 큰 부분합과 오른쪽 구간에서 가장 왼쪽 수(mid+1)를 포함하는 부분합의 합이 중심을 지나는 가장 큰 부분합입니다. 다음은 위 설명에 대한 슈드코드입니다.
