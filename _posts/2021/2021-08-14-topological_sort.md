...
모든 그래프 dp문제에서 그래프는 DAG입니다.만약 사이클이 있다면 memorization또한 순환적으로 의존하게 되므로 문제가 생깁니다. 또한 위상정렬이 가능하다는 말은 그래프가 DAG라는 말과 동치입니다.
...
문제에서 다이나믹한 게임 이라고 나와있어 , dp문제인것을 의심할 수 있습니다.(ㅋㅋ..) 문제를 읽어보면 DAG인 것을 알수 있습니다.
